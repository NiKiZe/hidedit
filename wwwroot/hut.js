...
var HIDUsagePowerDevice = {
    Undefined: { value: 0x00, name: "Undefined" },
    iName: { value: 0x01, name: "iName" },
    PresentStatus: { value: 0x02, name: "PresentStatus" },
    ChangedStatus: { value: 0x03, name: "ChangedStatus" },
    UPS: { value: 0x04, name: "UPS" },
    PowerSupply: { value: 0x5, name: "PowerSupply" },
    BatterySystem: { value: 0x10, name: "BatterySystem" },
    BatterySystemID: { value: 0x11, name: "BatterySystemID" },
    Battery: { value: 0x12, name: "Battery" },
    BatteryID: { value: 0x13, name: "BatteryID" },
    Charger: { value: 0x14, name: "Charger" },
    ChargerID: { value: 0x15, name: "ChargerID" },
    PowerConverter: { value: 0x16, name: "PowerConverter" },
    PowerConverterID: { value: 0x17, name: "PowerConverterID" },
    OutletSystem: { value: 0x18, name: "OutletSystem" },
    OutletSystemID: { value: 0x19, name: "OutletSystemID" },
    Input: { value: 0x1a, name: "Input" },
    InputID: { value: 0x1b, name: "InputID" },
    Output: { value: 0x1c, name: "Output" },
    OutputID: { value: 0x1d, name: "OutputID" },
    Flow: { value: 0x1e, name: "Flow" },
    FlowID: { value: 0x1f, name: "FlowID" },
    Outlet: { value: 0x20, name: "Outlet" },
    OutletID: { value: 0x21, name: "OutletID" },
    Gang: { value: 0x22, name: "Gang" },
    GangID: { value: 0x23, name: "GangID" },
    PowerSummary: { value: 0x24, name: "PowerSummary" },
    PowerSummaryID: { value: 0x25, name: "PowerSummaryID" },
    Voltage: { value: 0x30, name: "Voltage" },
    Current: { value: 0x31, name: "Current" },
    Frequency: { value: 0x32, name: "Frequency" },
    ApparentPower: { value: 0x33, name: "ApparentPower" },
    ActivePower: { value: 0x34, name: "ActivePower" },
    PercentLoad: { value: 0x35, name: "PercentLoad" },
    Temperature: { value: 0x36, name: "Temperature" },
    Humidity: { value: 0x37, name: "Humidity" },
    BadCount: { value: 0x38, name: "BadCount" },
    ConfigVoltage: { value: 0x40, name: "ConfigVoltage" },
    ConfigCurrent: { value: 0x41, name: "ConfigCurrent" },
    ConfigFrequency: { value: 0x42, name: "ConfigFrequency" },
    ConfigApparentPower: { value: 0x43, name: "ConfigApparentPower" },
    ConfigActivePower: { value: 0x44, name: "ConfigActivePower" },
    ConfigPercentLoad: { value: 0x45, name: "ConfigPercentLoad" },
    ConfigTemperature: { value: 0x46, name: "ConfigTemperature" },
    ConfigHumidity: { value: 0x47, name: "ConfigHumidity" },
    SwitchOnControl: { value: 0x50, name: "SwitchOnControl" },
    SwitchOffControl: { value: 0x51, name: "SwitchOffControl" },
    ToggleControl: { value: 0x52, name: "ToggleControl" },
    LowVoltageTransfer: { value: 0x53, name: "LowVoltageTransfer" },
    HighVoltageTransfer: { value: 0x54, name: "HighVoltageTransfer" },	
    DelayBeforeReboot: { value: 0x55, name: "DelayBeforeReboot" },
    DelayBeforeStartup: { value: 0x56, name: "DelayBeforeStartup" },
    DelayBeforeShutdown: { value: 0x57, name: "DelayBeforeShutdown" },
    Test: { value: 0x58, name: "Test" },
    ModuleReset: { value: 0x59, name: "ModuleReset" },
    AudibleAlarmControl: { value: 0x5a, name: "AudibleAlarmControl" },
    Present: { value: 0x60, name: "Present" },
    Good: { value: 0x61, name: "Good" },
    InternalFailure: { value: 0x62, name: "InternalFailure" },
    VoltageOutOfRange: { value: 0x63, name: "VoltageOutOfRange" },
    FrequencyOutOfRange: { value: 0x64, name: "FrequencyOutOfRange" },
    Overload: { value: 0x65, name: "Overload" }, 
    OverCharged: { value: 0x66, name: "OverCharged" },
    OverTemperature: { value: 0x67, name: "OverTemperature" },
    ShutdownRequested: { value: 0x68, name: "ShutdownRequested" },
    ShutdownImminent: { value: 0x69, name: "ShutdownImminent" },
    SwitchOnOff: { value: 0x6b, name: "SwitchOn/Off" },
    Switchable: { value: 0x6c, name: "Switchable" },
    Used: { value: 0x6d, name: "Used" },
    Boost: { value: 0x6e, name: "Boost" },
    Buck: { value: 0x6f, name: "Buck" },
    Initialized: { value: 0x70, name: "Initialized" },
    Tested: { value: 0x71, name: "Tested" },
    AwaitingPower: { value: 0x72, name: "AwaitingPower" },
    CommunicationLost: { value: 0x73, name: "CommunicationLost" },
    iManufacturer: { value: 0xfd, name: "iManufacturer" },
    iProduct: { value: 0xfe, name: "iProduct" },
    iSerialNumber: { value: 0xff, name: "iSerialNumber" },
    name: "HIDUsagePowerDevice"
};

var HIDUsageBatterySystem = {
    Undefined: { value: 0x00, name: "Undefined" },
    SMBBatteryMode: { value: 0x1, name: "SMBBatteryMode" },
    SMBBatteryStatus: { value: 0x2, name: "SMBBatteryStatus" },
    SMBAlarmWarning: { value: 0x3, name: "SMBAlarmWarning" },
    SMBChargerMode: { value: 0x4, name: "SMBChargerMode" },
    SMBChargerStatus: { value: 0x5, name: "SMBChargerStatus" },
    SMBChargerSpecInfo: { value: 0x6, name: "SMBChargerSpecInfo" },
    SMBSelectorState: { value: 0x7, name: "SMBSelectorState" },
    SMBSelectorPresets: { value: 0x8, name: "SMBSelectorPresets" },
    SMBSelectorInfo: { value: 0x9, name: "SMBSelectorInfo" },
    OptionalMfgFunction1: { value: 0x10, name: "OptionalMfgFunction1" },
    OptionalMfgFunction2: { value: 0x11, name: "OptionalMfgFunction2" },
    OptionalMfgFunction3: { value: 0x12, name: "OptionalMfgFunction3" },
    OptionalMfgFunction4: { value: 0x13, name: "OptionalMfgFunction4" },
    OptionalMfgFunction5: { value: 0x14, name: "OptionalMfgFunction5" },
    ConnectionToSMBus: { value: 0x15, name: "ConnectionToSMBus" },
    OutputConnection: { value: 0x16, name: "OutputConnection" },
    ChargerConnection: { value: 0x17, name: "ChargerConnection" },
    BatteryInsertion: { value: 0x18, name: "BatteryInsertion" },
    Usenext: { value: 0x19, name: "Usenext" },
    OKToUse: { value: 0x1a, name: "OKToUse" },
    BatterySupported: { value: 0x1b, name: "BatterySupported" },
    SelectorRevision: { value: 0x1c, name: "SelectorRevision" },
    ChargingIndicator: { value: 0x1d, name: "ChargingIndicator" },
    ManufacturerAccess: { value: 0x28, name: "ManufacturerAccess" },
    RemainingCapacityLimit: { value: 0x29, name: "RemainingCapacityLimit" },
    RemainingTimeLimit: { value: 0x2a, name: "RemainingTimeLimit" },
    AtRate: { value: 0x2b, name: "AtRate" },
    CapacityMode: { value: 0x2c, name: "CapacityMode" },
    BroadcastToCharger: { value: 0x2d, name: "BroadcastToCharger" },
    PrimaryBattery: { value: 0x2e, name: "PrimaryBattery" },
    ChargeController: { value: 0x2f, name: "ChargeController" },
    TerminateCharge: { value: 0x40, name: "TerminateCharge" },
    TerminateDischarge: { value: 0x41, name: "TerminateDischarge" },
    BelowRemainingCapacityLimit: { value: 0x42, name: "BelowRemainingCapacityLimit" },
    RemainingTimeLimitExpired: { value: 0x43, name: "RemainingTimeLimitExpired" },
    Charging: { value: 0x44, name: "Charging" },
    Discharging: { value: 0x45, name: "Discharging" },
    FullyCharged: { value: 0x46, name: "FullyCharged" },
    FullyDischarged: { value: 0x47, name: "FullyDischarged" },
    ConditioningFlag: { value: 0x48, name: "ConditioningFlag" },
    AtRateOK: { value: 0x49, name: "AtRateOK" },
    SMBErrorCode: { value: 0x4a, name: "SMBErrorCode" },
    NeedReplacement: { value: 0x4b, name: "NeedReplacement" },
    AtRateTimeToFull: { value: 0x60, name: "AtRateTimeToFull" },
    AtRateTimeToEmpty: { value: 0x61, name: "AtRateTimeToEmpty" },
    AverageCurrent: { value: 0x62, name: "AverageCurrent" },
    Maxerror: { value: 0x63, name: "Maxerror" },
    RelativeStateOfCharge: { value: 0x64, name: "RelativeStateOfCharge" },
    AbsoluteStateOfCharge: { value: 0x65, name: "AbsoluteStateOfCharge" },
    RemainingCapacity: { value: 0x66, name: "RemainingCapacity" },
    FullChargeCapacity: { value: 0x67, name: "FullChargeCapacity" },
    RunTimeToEmpty: { value: 0x68, name: "RunTimeToEmpty" },
    AverageTimeToEmpty: { value: 0x69, name: "AverageTimeToEmpty" },
    AverageTimeToFull: { value: 0x6a, name: "AverageTimeToFull" },
    CycleCount: { value: 0x6b, name: "CycleCount" },
    BattPackModelLevel: { value: 0x80, name: "BattPackModelLevel" },
    InternalChargeController: { value: 0x81, name: "InternalChargeController" },
    PrimaryBatterySupport: { value: 0x82, name: "PrimaryBatterySupport" },
    DesignCapacity: { value: 0x83, name: "DesignCapacity" },
    SpecificationInfo: { value: 0x84, name: "SpecificationInfo" },
    ManufacturerDate: { value: 0x85, name: "ManufacturerDate" },
    SerialNumber: { value: 0x86, name: "SerialNumber" },
    iManufacturerName: { value: 0x87, name: "iManufacturerName" },
    iDevicename: { value: 0x88, name: "iDevicename" }, /* sic! */
    iDeviceChemistry: { value: 0x89, name: "iDeviceChemistry" }, /* misspelled as "iDeviceChemistery" in spec. */
    ManufacturerData: { value: 0x8a, name: "ManufacturerData" },
    Rechargeable: { value: 0x8b, name: "Rechargeable" },
    WarningCapacityLimit: { value: 0x8c, name: "WarningCapacityLimit" },
    CapacityGranularity1: { value: 0x8d, name: "CapacityGranularity1" },
    CapacityGranularity2: { value: 0x8e, name: "CapacityGranularity2" },
    iOEMInformation: { value: 0x8f, name: "iOEMInformation" },
    InhibitCharge: { value: 0xc0, name: "InhibitCharge" },
    EnablePolling: { value: 0xc1, name: "EnablePolling" },
    ResetToZero: { value: 0xc2, name: "ResetToZero" },
    ACPresent: { value: 0xd0, name: "ACPresent" },
    BatteryPresent: { value: 0xd1, name: "BatteryPresent" },
    PowerFail: { value: 0xd2, name: "PowerFail" },
    AlarmInhibited: { value: 0xd3, name: "AlarmInhibited" },
    ThermistorUnderRange: { value: 0xd4, name: "ThermistorUnderRange" },
    ThermistorHot: { value: 0xd5, name: "ThermistorHot" },
    ThermistorCold: { value: 0xd6, name: "ThermistorCold" },
    ThermistorOverRange: { value: 0xd7, name: "ThermistorOverRange" },
    VoltageOutOfRange: { value: 0xd8, name: "VoltageOutOfRange" },
    CurrentOutOfRange: { value: 0xd9, name: "CurrentOutOfRange" },
    CurrentNotRegulated: { value: 0xda, name: "CurrentNotRegulated" },
    VoltageNotRegulated: { value: 0xdb, name: "VoltageNotRegulated" },
    MasterMode: { value: 0xdc, name: "MasterMode" },
    ChargerSelectorSupport: { value: 0xf0, name: "ChargerSelectorSupport" },
    ChargerSpec: { value: 0xf1, name: "ChargerSpec" },
    Level2: { value: 0xf2, name: "Level2" },
    Level3: { value: 0xf3, name: "Level3" },
    name: "HIDUsageBatterySystem"
};
var HIDUsagePage = {
    ...
    PowerDevice:            { value: 0x84, usage: HIDUsagePowerDevice, name: "Power Device" },
    BatterySystem:          { value: 0x85, usage: HIDUsageBatterySystem, name: "Battery System" },
    Power:                  { value: [0x86, 0x87], usage: null, name: "Power" },
